	...
	function edc_query_cursos($cantidad = -1){
		...
		?>
				...
				<div class="col-md-6 col-lg-4  mb-3">
		                    <div class="card">
		                       <!-- <img src="img/clase1.jpg" alt="" class="card-img-top"> -->
		                       <?php  the_post_thumbnail('mediano',array('class' => 'card-img-top')); ?>
		                        <div class="card-meta bg-primary p-3 text-light d-flex justify-content-between align-items-center">
		                        	...
		                        	?>
		                        	<div>
		                            <p class="m-0">Fecha de inicio: <?php echo $fecha; ?></p>		                            
		                            <p class="m-0">Hora :  <?php echo $hora; ?></p>
		                        	</div>
		                            
		                            <span class="badge badge-secondary p-2"><?php

		                            	echo money_format('%i', $costo);
		                        ...
		                        <div class="card-body">
		                            ...
		                            <p class="card-subtitle">
		                            	<?php 
		                    		      ...
		                    		      echo get_post_meta(get_the_ID(), 'edc_cursos_subtitulo',true);
		                            ...
		                            <a href="<?php the_permalink(); ?>" class="btn btn-primary d-block d-md-inline">Mas informacion</a>
		                        </div>
		                    </div>
		                </div>
